...
$prod = mysqli_query($koneksi, "SELECT * FROM ordercustomer WHERE status = 'Pengerjaan'");
$pending = mysqli_query($koneksi, "SELECT * FROM ordercustomer WHERE status = 'Pending'");
$henti = mysqli_query($koneksi, "SELECT * FROM ordercustomer WHERE status = 'Hentikan'");
$selesai = mysqli_query($koneksi, "SELECT * FROM ordercustomer WHERE status = 'Selesai'");
...
$ordprd = mysqli_query($koneksi, "SELECT * FROM ordercustomer WHERE status != 'Belum Bayar' and status != 'Lunas'");
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="halaman_ceo.php">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="../sales/halaman_sales.php">Sales Dept</a>
                            </nav>
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="../produksi/halaman_produksi.php">Production Dept </a>
                            </nav>
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="../purchasing/halaman_purchasing.php">Purchasing Dept</a>
                            </nav>
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="../finance/halaman_finance.php">Finance Dept</a>
                            </nav>
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="../admin/halaman_admin.php">Admin Dept</a>
                            </nav>
                        </div>
